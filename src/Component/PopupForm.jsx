        ...
        <form className="p-6 space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="relative">
            <input
              ...
              className="peer w-full px-4 py-3 border border-gray-300 rounded-xl placeholder-transparent focus:outline-none focus:ring-2 focus:ring-[#4C34A5] transition"
            />
            <label className="absolute left-4 top-3 text-gray-400 text-sm peer-placeholder-shown:text-base peer-focus:-top-2 peer-focus:text-sm bg-white px-1 transition">
              Email
            </label>
          </div>
          ...
          <div className="flex gap-2">
            <select
              ...
              className="w-1/3 px-3 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#4C34A5] outline-none"
            >
              <option value="+91">India +91</option>
              <option value="+1">USA +1</option>
              <option value="+44">UK +44</option>
